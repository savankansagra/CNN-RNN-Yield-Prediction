...
train_xdata = np.array([np.reshape(x, (28, 28)) for x in mnist.train.images]) # [55000, 28, 28]
test_xdata = np.array([np.reshape(x, (28, 28)) for x in mnist.test.images]) # [10000, 28, 28]
